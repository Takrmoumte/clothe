  ...
  const ProductItem = ({ product, addCart, backImage, des, addWishlist, cartClass, productDetail, addCompare, title }) => {
    ...
    const src1 = "/assets/images/pro3/img1.jpeg";
    const src2= "/assets/images/pro3/img2.jpeg";
    const src3 = "/assets/images/pro3/8.jpg";
      ...
      <div className="product-box product-wrap">
        <div className="img-wrapper">
          <div className="lable-block">
            {product.is_recent === true ? <span className="lable3">new</span> : ""}
            {product.sale === true ? <span className="lable4">on sale</span> : ""}
          </div>
          <div className="front" onClick={clickProductDetail}>
            <Media src={`${image ? image : src1}`} className="img-fluid" alt="" />
          </div>
          {backImage ? (
            backImage === undefined ? (
              false
              ...
              <div className="back" onClick={clickProductDetail}>
                <Media src={`${image ? image : src3}`} className="img-fluid m-auto" alt="" />
              </div>
            )
          ) : (
            ""
            ...
            <Modal isOpen={modalCompare} toggle={toggleCompare} size="lg" centered>
              <ModalBody>
                <Row className="compare-modal">
                  <Col lg="12">
                    <div className="media">
                      <Media src={`${product.variants && image ? image : src1}`} alt="" className="img-fluid" />
