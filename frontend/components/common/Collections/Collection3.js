...
import dataProduct from "../../../dataold/dataProduct";
...
const  TopCollection = ({dressList, type, title, subtitle, designClass, noSlider, cartClass, productSlider, titleClass, noTitle, innerClass, inner, backImage }) => {
              ...
              <Col>
                ...
                {delayProduct ? (
                  ...
                  <Slider {...productSlider} className="product-m no-arrow">
                    ...
                    {dressList && dressList.results  &&
                      dressList.results.map((product, i) => (
                        <div key={i}>
